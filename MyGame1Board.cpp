...
CMyGame1Board::CMyGame1Board(void)
: m_arrBoard(NULL),
...
CMyGame1Board::CMyGame1Board(const CMyGame1Board& board)
{
...
void CMyGame1Board::SetupBoard(void)
{
...
COLORREF CMyGame1Board::GetBoardSpace(int row, int col)
{
...
void CMyGame1Board::DeleteBoard(void)
{
...
void CMyGame1Board::CreateBoard(void)
{
...
int CMyGame1Board::DeleteBlocks(int row, int col)
{
...
int CMyGame1Board::DeleteNeighborBlocks(int row, int col, int color,
	Direction direction)
{
...
void CMyGame1Board::CompactBoard(void)
{
...
bool CMyGame1Board::IsGameOver(void) const
{
