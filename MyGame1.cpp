...
// MyGame1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMyGame1App, CWinApp)
...
// Единственный объект CMyGame1App

CMyGame1App theApp;


// инициализация CMyGame1App
...
BOOL CMyGame1App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMyGame1Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMyGame1View));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений CMyGame1App
